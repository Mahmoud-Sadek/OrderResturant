package com.sadek.apps.orderresturant.helper;
...
public class NotificationHelper extends ContextWrapper {
    ...
    public static final String CHANNEL_ID="com.sadek.apps.orderresturant";
    public static final String CHANNEL_NAME="OrderRestaurant";
    ...
    @RequiresApi(api = Build.VERSION_CODES.O)
    public  android.app.Notification.Builder getFoodOrderNotificationChannel(String title, String body, Uri soundUri)
